...
(TODO Thirdly, save the simulation states in the database. This gives you a history so you can analyze each robot later.)
The amount of simulation states depends on the ``sampling_frequency`` defined earlier.
