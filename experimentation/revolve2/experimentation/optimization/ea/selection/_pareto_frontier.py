...
def pareto_frontier(
    ...
    :param frontier_order: List of orders for the values used in frontier selection. True = Descending, False = Ascending.
    :param to_take: The amount of individuals to return from the frontier.
    :returns: The index of the individuals that were selected.
    """
    ...
    """Domination order is Ascending by default. The more individuals are dominated by a target, the better."""
