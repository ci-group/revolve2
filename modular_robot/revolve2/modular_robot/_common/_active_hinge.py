...
class ActiveHinge(Module):
    ...
    def __init__(self, rotation: float | RightAngles, color: Color = Color(255, 255, 255, 255),  attachment_position: int = 5):
        """
        ...
        super().__init__(1, rotation_converted, color, attachment_position)
