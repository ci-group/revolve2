...
class Brick(Module):
    ...
    def __init__(
        self, rotation: float | RightAngles, color: Color = Color(50, 50, 255, 255), attachment_position: int = 5
    ):
        """
        ...
        super().__init__(3, rotation_converted, color, attachment_position)
