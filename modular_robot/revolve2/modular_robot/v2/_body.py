...
from revolve2.modular_robot.v2._active_hinge import ActiveHinge
from revolve2.modular_robot.v2._brick import Brick
from revolve2.modular_robot.v2._core import Core
        ...
        for name_suffix, child_index, angle in [
            ...
            if child is not None:
                ...
                attachment_offset = __get_attachment_offset(
                    child.properties.attachment_position, angle
                )
