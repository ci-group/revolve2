...
class ModularRobotScene:
    ...
    _robots: list[tuple[AerialRobot, Pose, bool]] = field(default_factory=list)
    """
    ...
    def add_robot(
        self, robot: AerialRobot, pose: Pose = Pose(), translate_z_aabb: bool = True
    ) -> None:
        """
    ...
    def to_simulation_scene(
        self,
    ) -> tuple[Scene, dict[UUIDKey[AerialRobot], MultiBodySystem]]:
        """
