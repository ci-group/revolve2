...
from revolve2.revolve.robot.body.robogen.random_robogen_body import _get_symbol_from_orientation
...
from revolve2.revolve.robot.soul.cppn_adapter import CPPNAdapter
