...
from nca.core.genome.representations.symbolic_representation import SymbolicRepresentation, LSystemRepresentation
...
class DirectRepresentationTest(unittest.TestCase):
    ...
    def test_symbolic(self):
        representation_1 = SymbolicRepresentation(TestColorSymbol)
        representation_2 = SymbolicRepresentation(TestColorSymbol)
