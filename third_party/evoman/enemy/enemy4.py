        ...
        if game.start == 1:
            ...
            if atack3 == 1:
                ...
                if self.fireflash == 0:
                    ...
                    for i in range (0,3):
                        self.twists.append(Bullet_e4((self.rect.x ,self.rect.y ), self.direction, i, len(self.twists), game.sprite_enemy))
                else :
                    self.timeenemy -= 1
           ...
           # changes bullets images according to the enemy direction
            ...
            if self.imune == 1:
                if game.attack_timer%2==0:
                    self.image = pygame.image.load(image_path + '/fireball.png')
                else:
                    self.image = pygame.image.load(image_path + '/fireball2.png')
