    ...
    def update(self, dt, game):
        ...
        if game.start == 1:
            ...
            if atack1 == 1:
                ...
                self.twists.append(Bullet_e7((self.rect.x,self.rect.y), self.direction, len(self.twists), game.sprite_enemy))
            ...
            if self.bullets == 0: # if the bubblues have gone away, enemy is abble to realease new bubbles.
                ...
                for i in range(0,rand):
                    if atack3 == 1:
                        ...
                        self.bullets += 1
                        self.twists.append(Bullet_e72((self.rect.x+self.direction*i*30  ,self.rect.y-i*30), self.direction, len(self.twists), game.sprite_enemy))
