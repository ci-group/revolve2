...
tilemap = map_path + 'map1.tmx'  # scenario
...
class Bullet_e1(pygame.sprite.Sprite):
    ...
    image = pygame.image.load(image_path + '/bullet2_l.png')
    ...
    def __init__(self, location, direction, n_twist, *groups):
        ...
        if self.direction == 1:
            self.image = pygame.image.load(image_path + '/bullet2_r.png')
        else:
            self.image = pygame.image.load(image_path + '/bullet2_l.png')
