...
from demo_controller import PlayerController, EnemyController
...
class TrainingEvomanEnvironment(EvomanEnvironment):
...
env = TrainingEvomanEnvironment(experiment_name=experiment_name, enemies=[2], playermode="ai", level=2, speed="fastest",
								player_controller=PlayerController(n_hidden_neurons), enemy_controller="static")
