...
class Bullet_p(pygame.sprite.Sprite):
    ...
    def __init__(self, location, direction, n_twist, *groups):
        ...
        if self.direction == 1:
            self.image = pygame.image.load(image_path + '/bullet_r.png')
        else:
            self.image = pygame.image.load(image_path + '/bullet_l.png')
...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, location, enemyn, level, *groups):
        ...
        self.spriteDefinition = SpriteDefinition(image_path + '/EvoManSprites.png', 0, 0, 43, 59)
        ...
        if game.freeze_p == 0  and game.start == 1:
            ...
            if  shoot == 1 and not self.gun_cooldown:
                ...
                if game.sound == "on" and game.playermode == "human":
                    sound = pygame.mixer.Sound(sounds_path + '/scifi003.wav')
